...
import com.app.R
import com.app.domain.extension.toCamelCase
...
fun TextView.semiBold() {
    typeface = ResourcesCompat.getFont(context, R.font.source_sans_pro_semi_bold)
}
...
fun AppCompatActivity.initBackToolbar(toolbar: Toolbar) {
    ...
    supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_chevron_left_back)
