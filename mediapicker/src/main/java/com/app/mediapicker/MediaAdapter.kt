...
import com.app.mediapicker.widget.PickerImageView
import java.util.*
...
class MediaAdapter(context: Context, c: Cursor, flags: Int,
                   ...
                   private var mMediaType: Int, private val mMediaOptions: MediaOptions
) : CursorAdapter(context, c, flags), RecyclerListener {
    ...
    constructor(context: Context, c: Cursor, flags: Int,
                mediaImageLoader: MediaImageLoader, mediaType: Int, mediaOptions: MediaOptions
