...
import com.app.mediapicker.CropListener
import com.app.mediapicker.MediaItem
import com.app.mediapicker.MediaOptions
import com.app.mediapicker.MediaSelectedListener
import com.app.mediapicker.imageloader.MediaImageLoader
import com.app.mediapicker.imageloader.MediaImageLoaderImpl
import com.app.mediapicker.utils.MediaUtils
import com.app.mediapicker.utils.MessageUtils
import com.app.mediapicker.utils.RecursiveFileObserver
import com.app.mediapicker.utils.Utils
 ...
 *
 */
class MediaPickerActivity : AppCompatActivity(), MediaSelectedListener, CropListener, FragmentManager.OnBackStackChangedListener,
    FragmentHost {
        ...
        if (takeVideoIntent.resolveActivity(packageManager) != null) {
            ...
            if (max != Integer.MAX_VALUE) {
                ...
                if (mMediaOptions!!.isShowWarningVideoDuration) {
                    val dialog = MediaPickerErrorDialog.newInstance(
    ...
    private fun showVideoInvalid(msg: String) {
        val errorDialog = MediaPickerErrorDialog.newInstance(msg)
